<div id="page-wrapper">
  <div id="top-bar">
    <div class="wrapper">
      <div class="collect left"><?php print t("Are getting married?");?> <a href="#"><?php print t("Start Here");?></a></div>
      
      <div id="top-icons" class="right"> <a id="follow-twitter" class="follow-icon" target="_blank" href="http://twitter.com/arabiaweddings"> Follow us on Twitter</a> <a id="follow-facebook" class="follow-icon" target="_blank" href="http://www.facebook.com/ArabiaWeddings"> Our Facebook page</a> <a id="follow-pinterest" class="follow-icon" target="_blank" href="http://pinterest.com/arabiaweddings"> Pinterest</a> <a id="follow-instagram" class="follow-icon" target="_blank" href="http://instagram.com/arabiaweddings">instagram</a> <a id="follow-rss" class="follow-icon" target="_blank" href="/rss"> RSS Feed</a> <?php print render($page['search']);?> </div>
